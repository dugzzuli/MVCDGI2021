...
if __name__ == '__main__':
    ...
    for data in d:
        for link in ['Mean']:
            ...
            resultsDir = 'baseline/DMGI/{}/{}'.format(args.isMeanOrCat,args.dataset)
            mkdir(resultsDir)
            
            filePath = os.path.join(resultsDir, '{}_{}_{}_{}.txt'.format('Y 'if args.Weight else 'N',args.dataset,args.isMeanOrCat,config[args.dataset]['norm']))
