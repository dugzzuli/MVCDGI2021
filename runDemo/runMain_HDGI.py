...
def runMain(dataset,link):
    ...
    # input arguments
    parser = argparse.ArgumentParser(description='HDGI')
    parser.add_argument('--embedder', nargs='?', default='HDGI')
    ...
    resultsDir = 'baseline/HDGI/{}/{}'.format(link,dataset_name)
    mkdir(resultsDir)
