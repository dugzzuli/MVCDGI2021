...
class DMGIML(embedder):
    ...
    def training(self,f):
        ...
        for epoch in iters:
            ...
            loss += self.args.reg_coef * reg_loss+result['cl_loss']
            ...
            if(epoch%10)==0:
                ...
                if(accMax<acc):
                    ...
                    nmiMax=nmi
                    curepoch=epoch
                retxt="epoch:{} acc:{} nmi:{} accMax:{} nmiMax:{} curepoch:{}".format(epoch,acc,nmi,accMax,nmiMax,curepoch)
...
class modeler(nn.Module):
    ...
    def forward(self, feature, adj, shuf, sparse, msk, samp_bias1, samp_bias2):
        ...
        cl_loss=0
        # for v1 in range(self.args.nb_graphs):
        #     for v2 in range(v1,self.args.nb_graphs):
        #         cl_loss += crossview_contrastive_Loss(h_1_all[v1].squeeze(), h_1_all[v2].squeeze(), 9.0)

        result['cl_loss'] = cl_loss*0
